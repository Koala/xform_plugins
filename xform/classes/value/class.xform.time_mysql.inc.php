...
class rex_xform_time_mysql extends rex_xform_abstract
{
  ...
  function enterObject()
  {
    ...
    if (!is_array($this->getValue()) && (strlen($this->getValue()) == 2 || strlen($this->getValue()) == 4)){
      ...
      $min  = (int) substr($this->getValue(),3,2);
    } else {
    ...
    if($hour != '') {
      $this->params['value_pool']['email'][$this->getName()] = $hour.':'.$min.':00';
      $this->params['value_pool']['sql'][$this->getName()]   = $hour.':'.$min.':00';
    }
  ...
  {
    return 'time -> Beispiel: time_mysql|feldname|label|minutenrater 00,15,30,45';
  }
  ...
  function getDefinitions()
  {
    return array(
          ...
          'values' => array(
                ...
                array( 'type' => 'text',   'label' => 'Listen-Format (default: "H:i")'),
              ),
