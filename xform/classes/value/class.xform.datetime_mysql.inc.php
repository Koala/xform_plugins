...
class rex_xform_datetime_mysql extends rex_xform_abstract
{
  ...
  {
    return 'datetime -> Beispiel: datetime_mysql|feldname|Text *|jahrstart|jahrsende|minutenformate 00,15,30,45';
  }
